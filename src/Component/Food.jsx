...
const Food = () => {
  return (
    <div className="bg-slate-100 flex flex-col lg:flex-row items-center justify-center lg:p-10 lg:w-[1000px] lg:h-[325px] h-[700px] mx-auto gap-8 border-2 border-[#023222]">
      <figure>
